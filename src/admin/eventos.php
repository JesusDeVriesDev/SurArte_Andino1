...
<main>
  ...
  <div class="admin-hero">
    ...
    <div>
      ...
      <span style="font-family:var(--ff-m);font-size:.58rem;letter-spacing:.1em;text-transform:uppercase;color:var(--clay)">Eventos</span>
    </div>
    ...
    <div class="admin-hero-actions" style="padding-top:70px;margin-bottom:8px">
      <button class="btn btn-gold" style="font-size:.7rem" onclick="abrirModal()">+ Crear evento</button>
      <a href="<?= $base ?>/src/admin/admin.php" class="btn btn-outline" style="font-size:.7rem">← Panel</a>
    </div>
  </div>
