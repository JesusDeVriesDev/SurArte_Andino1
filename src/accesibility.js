...
// Versión global: funciona en cualquier página sin configuración adicional.
(function () {
  'use strict';
  ...
  function textoDeElemento(el) {
    ...
    if (el.closest && el.closest('#btn-accesibilidad, #acc-toast')) return '';
  ...
  // Previene duplicados: si el script se carga más de una vez en la misma página,
  // el segundo intento no hace nada.
  function crearBoton() {
    if (document.getElementById('btn-accesibilidad')) return;
  ...
  // Funciona sin importar en qué punto del ciclo de vida de la página se cargue el script:
  // <head>, <body>, defer, async, o inyectado dinámicamente.
